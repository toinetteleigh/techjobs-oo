...
public class JobController {
    ...
    public String index(Model model, int id) {
        ...
        singleJob = jobData.findById(id);
        model.addAttribute(singleJob);
    ...
    public String add(Model model, @Valid JobForm jobForm, Errors errors) {
        ...
        Job createdJob = new Job(jobForm.getName(), jobData.getEmployers().findById(jobForm.getEmployerId()),
        ...
        return "redirect:/job?id=" + createdJob.getId();
    }
}
